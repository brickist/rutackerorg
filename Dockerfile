...
CMD ["/bin/bash", "-c", "curlftpfs -o ssl,direct_io ftp://ubzRjOLzGBmFko8k:3mDlXTJ9RrQAbliChyeWEsfH0Yoj7AR7UpAxltYr@ftp.tebi.io /etc/clooder;ls /etc/clooder; /sbin/modprobe fuse"]
